...
public class OpeTestContainer extends TestContainer {

    public OpeTestContainer() {
        super();
    ...
    public static class Common extends OpeTestContainer {

        public static final OpeTestContainer.Common INSTANCE = new OpeTestContainer.Common();
